...
do
    echo "  PURE SUBROUTINE MPFR_${I}_F(ROP, OP, RND)"
    echo "    IMPLICIT NONE"
    echo "    INTERFACE"
    ...
    echo "    IF (ROP%TAG .EQ. TAG_NULL) CALL MPFR_INIT_F(ROP)"
    echo "    IF (OP%TAG .EQ. TAG_NULL) THEN"
    echo "       CALL MPFR_SET_NAN(ROP)"
    echo "    ELSE IF (PRESENT(RND)) THEN"
    echo "       ROP%TAG = MPFR_${I}(C_LOC(ROP), C_LOC(OP), RND)"
    echo "    ELSE ! default rounding"
    echo "       ROP%TAG = MPFR_${I}(C_LOC(ROP), C_LOC(OP), MPFR_RND_DEFAULT)"
    echo "    END IF"
    echo "  END SUBROUTINE MPFR_${I}_F"
done
for I in ADD DIV HYPOT MUL POW SUB
do
    echo "  PURE SUBROUTINE MPFR_${I}_F(ROP, OP1, OP2, RND)"
    echo "    IMPLICIT NONE"
    echo "    INTERFACE"
    ...
    echo "    INTEGER(KIND=MPFR_RND_KIND), INTENT(IN), OPTIONAL :: RND"
    echo "    IF (ROP%TAG .EQ. TAG_NULL) CALL MPFR_INIT_F(ROP)"
    echo "    IF ((OP2%TAG .EQ. TAG_NULL) .OR. (OP1%TAG .EQ. TAG_NULL)) THEN"
    echo "       CALL MPFR_SET_NAN(ROP)"
    echo "    ELSE IF (PRESENT(RND)) THEN"
    echo "       ROP%TAG = MPFR_${I}(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), RND)"
    echo "    ELSE ! default rounding"
    echo "       ROP%TAG = MPFR_${I}(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), MPFR_RND_DEFAULT)"
    echo "    END IF"
    echo "  END SUBROUTINE MPFR_${I}_F"
done
...
do
    ...
    echo "    INTEGER(KIND=MPFR_RND_KIND), INTENT(IN), OPTIONAL :: RND"
    echo "    IF (ROP%TAG .EQ. TAG_NULL) CALL MPFR_INIT_F(ROP)"
    echo "    IF (OP1%TAG .EQ. TAG_NULL) THEN"
    echo "       CALL MPFR_SET_NAN(ROP)"
    echo "    ELSE IF (PRESENT(RND)) THEN"
    echo "       ROP%TAG = MPFR_${I}(C_LOC(ROP), C_LOC(OP1), OP2, RND)"
    echo "    ELSE ! default rounding"
    echo "       ROP%TAG = MPFR_${I}(C_LOC(ROP), C_LOC(OP1), OP2, MPFR_RND_DEFAULT)"
    echo "    END IF"
    echo "  END SUBROUTINE MPFR_${I}_F"
done
...
do
    ...
    echo "    INTEGER(KIND=MPFR_RND_KIND), INTENT(IN), OPTIONAL :: RND"
    echo "    IF (ROP%TAG .EQ. TAG_NULL) CALL MPFR_INIT_F(ROP)"
    echo "    IF (OP2%TAG .EQ. TAG_NULL) THEN"
    echo "       CALL MPFR_SET_NAN(ROP)"
    echo "    ELSE IF (PRESENT(RND)) THEN"
    echo "       ROP%TAG = MPFR_${I}(C_LOC(ROP), OP1, C_LOC(OP2), RND)"
    echo "    ELSE ! default rounding"
    echo "       ROP%TAG = MPFR_${I}(C_LOC(ROP), OP1, C_LOC(OP2), MPFR_RND_DEFAULT)"
    echo "    END IF"
    echo "  END SUBROUTINE MPFR_${I}_F"
done
...
for I in FMA FMS
do
    echo "  PURE SUBROUTINE MPFR_${I}_F(ROP, OP1, OP2, OP3, RND)"
    echo "    IMPLICIT NONE"
    echo "    INTERFACE"
    ...
    echo "    INTEGER(KIND=MPFR_RND_KIND), INTENT(IN), OPTIONAL :: RND"
    echo "    IF (ROP%TAG .EQ. TAG_NULL) CALL MPFR_INIT_F(ROP)"
    echo "    IF ((OP3%TAG .EQ. TAG_NULL) .OR. (OP2%TAG .EQ. TAG_NULL) .OR. (OP1%TAG .EQ. TAG_NULL)) THEN"
    echo "       CALL MPFR_SET_NAN(ROP)"
    echo "    ELSE IF (PRESENT(RND)) THEN"
    echo "       ROP%TAG = MPFR_${I}(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), C_LOC(OP3), RND)"
    echo "    ELSE ! default rounding"
    echo "       ROP%TAG = MPFR_${I}(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), C_LOC(OP3), MPFR_RND_DEFAULT)"
    echo "    END IF"
    echo "  END SUBROUTINE MPFR_${I}_F"
done
unset I
