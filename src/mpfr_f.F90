...
CONTAINS
  ...
  PURE SUBROUTINE MPFR_SET_F(LHS, RHS, RND)
    ...
    IF (RHS%TAG .EQ. TAG_NULL) THEN
       IF (LHS%TAG .NE. TAG_NULL) CALL MPFR_CLEAR_F(LHS)
       RETURN
    ELSE IF (LHS%TAG .EQ. TAG_NULL) THEN
  ...
  PURE SUBROUTINE MPFR_SET_SI_2EXP_F(ROP, OP, E, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    INTEGER(KIND=MPFR_RND_KIND), INTENT(IN), OPTIONAL :: RND
    IF (ROP%TAG .EQ. TAG_NULL) CALL MPFR_INIT_F(ROP)
    IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_SET_SI_2EXP(C_LOC(ROP), OP, E, RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_SET_SI_2EXP(C_LOC(ROP), OP, E, MPFR_RND_DEFAULT)
    END IF
  ...
  PURE SUBROUTINE MPFR_SET_STR_F(ROP, S, RND, I)
    ...
    END IF
    IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_STRTOFR(C_LOC(ROP), C_LOC(C), C_LOC(E), INT(L, c_int), RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_STRTOFR(C_LOC(ROP), C_LOC(C), C_LOC(E), INT(L, c_int), MPFR_RND_DEFAULT)
    END IF
    DEALLOCATE(C)
  ...
  PURE SUBROUTINE MPFR_ABS_F(ROP, OP, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    INTEGER(KIND=MPFR_RND_KIND), INTENT(IN), OPTIONAL :: RND
    IF (ROP%TAG .EQ. TAG_NULL) CALL MPFR_INIT_F(ROP)
    IF (OP%TAG .EQ. TAG_NULL) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_ABS(C_LOC(ROP), C_LOC(OP), RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_ABS(C_LOC(ROP), C_LOC(OP), MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_ABS_F
  PURE SUBROUTINE MPFR_CBRT_F(ROP, OP, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    IF (OP%TAG .EQ. TAG_NULL) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_CBRT(C_LOC(ROP), C_LOC(OP), RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_CBRT(C_LOC(ROP), C_LOC(OP), MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_CBRT_F
  PURE SUBROUTINE MPFR_NEG_F(ROP, OP, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    IF (OP%TAG .EQ. TAG_NULL) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_NEG(C_LOC(ROP), C_LOC(OP), RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_NEG(C_LOC(ROP), C_LOC(OP), MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_NEG_F
  PURE SUBROUTINE MPFR_REC_SQRT_F(ROP, OP, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    IF (OP%TAG .EQ. TAG_NULL) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_REC_SQRT(C_LOC(ROP), C_LOC(OP), RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_REC_SQRT(C_LOC(ROP), C_LOC(OP), MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_REC_SQRT_F
  PURE SUBROUTINE MPFR_SQR_F(ROP, OP, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    IF (OP%TAG .EQ. TAG_NULL) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_SQR(C_LOC(ROP), C_LOC(OP), RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_SQR(C_LOC(ROP), C_LOC(OP), MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_SQR_F
  PURE SUBROUTINE MPFR_SQRT_F(ROP, OP, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    IF (OP%TAG .EQ. TAG_NULL) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_SQRT(C_LOC(ROP), C_LOC(OP), RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_SQRT(C_LOC(ROP), C_LOC(OP), MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_SQRT_F
  PURE SUBROUTINE MPFR_ADD_F(ROP, OP1, OP2, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    INTEGER(KIND=MPFR_RND_KIND), INTENT(IN), OPTIONAL :: RND
    IF (ROP%TAG .EQ. TAG_NULL) CALL MPFR_INIT_F(ROP)
    IF ((OP2%TAG .EQ. TAG_NULL) .OR. (OP1%TAG .EQ. TAG_NULL)) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_ADD(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_ADD(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_ADD_F
  PURE SUBROUTINE MPFR_DIV_F(ROP, OP1, OP2, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    IF ((OP2%TAG .EQ. TAG_NULL) .OR. (OP1%TAG .EQ. TAG_NULL)) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_DIV(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_DIV(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_DIV_F
  PURE SUBROUTINE MPFR_HYPOT_F(ROP, OP1, OP2, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    IF ((OP2%TAG .EQ. TAG_NULL) .OR. (OP1%TAG .EQ. TAG_NULL)) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_HYPOT(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_HYPOT(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_HYPOT_F
  PURE SUBROUTINE MPFR_MUL_F(ROP, OP1, OP2, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    IF ((OP2%TAG .EQ. TAG_NULL) .OR. (OP1%TAG .EQ. TAG_NULL)) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_MUL(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_MUL(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_MUL_F
  PURE SUBROUTINE MPFR_POW_F(ROP, OP1, OP2, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    IF ((OP2%TAG .EQ. TAG_NULL) .OR. (OP1%TAG .EQ. TAG_NULL)) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_POW(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_POW(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_POW_F
  PURE SUBROUTINE MPFR_SUB_F(ROP, OP1, OP2, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    IF ((OP2%TAG .EQ. TAG_NULL) .OR. (OP1%TAG .EQ. TAG_NULL)) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_SUB(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_SUB(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_SUB_F
  PURE SUBROUTINE MPFR_ADD_SI_F(ROP, OP1, OP2, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    INTEGER(KIND=MPFR_RND_KIND), INTENT(IN), OPTIONAL :: RND
    IF (ROP%TAG .EQ. TAG_NULL) CALL MPFR_INIT_F(ROP)
    IF (OP1%TAG .EQ. TAG_NULL) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_ADD_SI(C_LOC(ROP), C_LOC(OP1), OP2, RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_ADD_SI(C_LOC(ROP), C_LOC(OP1), OP2, MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_ADD_SI_F
  PURE SUBROUTINE MPFR_DIV_SI_F(ROP, OP1, OP2, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    IF (OP1%TAG .EQ. TAG_NULL) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_DIV_SI(C_LOC(ROP), C_LOC(OP1), OP2, RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_DIV_SI(C_LOC(ROP), C_LOC(OP1), OP2, MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_DIV_SI_F
  PURE SUBROUTINE MPFR_MUL_SI_F(ROP, OP1, OP2, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    IF (OP1%TAG .EQ. TAG_NULL) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_MUL_SI(C_LOC(ROP), C_LOC(OP1), OP2, RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_MUL_SI(C_LOC(ROP), C_LOC(OP1), OP2, MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_MUL_SI_F
  PURE SUBROUTINE MPFR_SUB_SI_F(ROP, OP1, OP2, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    IF (OP1%TAG .EQ. TAG_NULL) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_SUB_SI(C_LOC(ROP), C_LOC(OP1), OP2, RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_SUB_SI(C_LOC(ROP), C_LOC(OP1), OP2, MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_SUB_SI_F
  PURE SUBROUTINE MPFR_SI_DIV_F(ROP, OP1, OP2, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    INTEGER(KIND=MPFR_RND_KIND), INTENT(IN), OPTIONAL :: RND
    IF (ROP%TAG .EQ. TAG_NULL) CALL MPFR_INIT_F(ROP)
    IF (OP2%TAG .EQ. TAG_NULL) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_SI_DIV(C_LOC(ROP), OP1, C_LOC(OP2), RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_SI_DIV(C_LOC(ROP), OP1, C_LOC(OP2), MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_SI_DIV_F
  PURE SUBROUTINE MPFR_SI_SUB_F(ROP, OP1, OP2, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    IF (OP2%TAG .EQ. TAG_NULL) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_SI_SUB(C_LOC(ROP), OP1, C_LOC(OP2), RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_SI_SUB(C_LOC(ROP), OP1, C_LOC(OP2), MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_SI_SUB_F
  PURE SUBROUTINE MPFR_ADD_D_F(ROP, OP1, OP2, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    IF (OP1%TAG .EQ. TAG_NULL) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_ADD_D(C_LOC(ROP), C_LOC(OP1), OP2, RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_ADD_D(C_LOC(ROP), C_LOC(OP1), OP2, MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_ADD_D_F
  PURE SUBROUTINE MPFR_DIV_D_F(ROP, OP1, OP2, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    IF (OP1%TAG .EQ. TAG_NULL) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_DIV_D(C_LOC(ROP), C_LOC(OP1), OP2, RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_DIV_D(C_LOC(ROP), C_LOC(OP1), OP2, MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_DIV_D_F
  PURE SUBROUTINE MPFR_MUL_D_F(ROP, OP1, OP2, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    IF (OP1%TAG .EQ. TAG_NULL) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_MUL_D(C_LOC(ROP), C_LOC(OP1), OP2, RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_MUL_D(C_LOC(ROP), C_LOC(OP1), OP2, MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_MUL_D_F
  PURE SUBROUTINE MPFR_SUB_D_F(ROP, OP1, OP2, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    IF (OP1%TAG .EQ. TAG_NULL) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_SUB_D(C_LOC(ROP), C_LOC(OP1), OP2, RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_SUB_D(C_LOC(ROP), C_LOC(OP1), OP2, MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_SUB_D_F
  PURE SUBROUTINE MPFR_D_DIV_F(ROP, OP1, OP2, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    IF (OP2%TAG .EQ. TAG_NULL) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_D_DIV(C_LOC(ROP), OP1, C_LOC(OP2), RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_D_DIV(C_LOC(ROP), OP1, C_LOC(OP2), MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_D_DIV_F
  PURE SUBROUTINE MPFR_D_SUB_F(ROP, OP1, OP2, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    IF (OP2%TAG .EQ. TAG_NULL) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_D_SUB(C_LOC(ROP), OP1, C_LOC(OP2), RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_D_SUB(C_LOC(ROP), OP1, C_LOC(OP2), MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_D_SUB_F
  PURE SUBROUTINE MPFR_FMA_F(ROP, OP1, OP2, OP3, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    INTEGER(KIND=MPFR_RND_KIND), INTENT(IN), OPTIONAL :: RND
    IF (ROP%TAG .EQ. TAG_NULL) CALL MPFR_INIT_F(ROP)
    IF ((OP3%TAG .EQ. TAG_NULL) .OR. (OP2%TAG .EQ. TAG_NULL) .OR. (OP1%TAG .EQ. TAG_NULL)) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_FMA(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), C_LOC(OP3), RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_FMA(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), C_LOC(OP3), MPFR_RND_DEFAULT)
    END IF
  END SUBROUTINE MPFR_FMA_F
  PURE SUBROUTINE MPFR_FMS_F(ROP, OP1, OP2, OP3, RND)
    IMPLICIT NONE
    INTERFACE
    ...
    IF ((OP3%TAG .EQ. TAG_NULL) .OR. (OP2%TAG .EQ. TAG_NULL) .OR. (OP1%TAG .EQ. TAG_NULL)) THEN
       CALL MPFR_SET_NAN(ROP)
    ELSE IF (PRESENT(RND)) THEN
       ROP%TAG = MPFR_FMS(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), C_LOC(OP3), RND)
    ELSE ! default rounding
       ROP%TAG = MPFR_FMS(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), C_LOC(OP3), MPFR_RND_DEFAULT)
    END IF
